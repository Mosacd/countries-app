      ...
      <header className={styles.header}>
        <nav className={styles.nav}>
          ...
          <ul className={styles.list}>
            <li> <Link to={""} className={styles.link}>{translations[currentLang].header.home}</Link></li>
            <li> <Link to={"Services"} className={styles.link}>{translations[currentLang].header.services}</Link></li>
            <li> <Link to={"contact"} className={styles.link}>{translations[currentLang].header.contact}</Link></li>
            <li> <Link to={"about"} className={styles.link}>{translations[currentLang].header.about}</Link></li>
