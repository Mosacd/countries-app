...
const EditForm:React.FC<{onEditFormChange:(e:React.ChangeEvent<HTMLInputElement>) => void,
     onEditFormSubmit:(e:React.FormEvent<HTMLFormElement>) => void,editFormState:{
        population: string,
        capitalCityEn: string,
        capitalCityKa: string,
      }, setEditModalOpen:React.Dispatch<React.SetStateAction<boolean>> }>
 = ({onEditFormChange,onEditFormSubmit,editFormState, setEditModalOpen}) => {
