...
//     textEn:
//       "Located in South America, Argentina is famous for its diverse landscapes, from the pampas to the Andes. Its capital, Buenos Aires, is known for its rich cultural scene, including tango music and dance, as well as European-inspired architecture. Argentina is also renowned for its beef and wine production.",
//     textKa:
//       "სამხრეთ ამერიკაში მდებარე არგენტინა ცნობილია თავისი მრავალფეროვანი პეიზაჟებით, პამპასიდან ანდესამდე. მისი დედაქალაქი ბუენოს აირესი ცნობილია თავისი მდიდარი კულტურული სცენით, მათ შორის ტანგოს მუსიკით და ცეკვით, ასევე ევროპული არქიტექტურით შთაგონებული. არგენტინა ასევე ცნობილია საქონლის ხორცისა და ღვინის წარმოებით",
//     id: "argentina",
//     likecount: 10,
//     isDeleted: false,
//   },
...
//     textEn:
//       "As the largest country in South America, Brazil is known for its Amazon rainforest, vibrant cities, and football culture. The capital, Brasília, was designed by architect Oscar Niemeyer and is known for its modernist architecture. Brazil is famous for its carnivals, samba music, and extensive beaches.",
//     textKa:
...
//     capitalCityKa: "ქაირო",
//     imageUrl:
//       "/src/assets/kevin-et-laurianne-langlais-Rk8yY0UfPx0-unsplash.jpg",
//     textEn:
